...
class employeeClass:
    def __init__(self, root):
        ...
        lbl_password = Label(self.root, text = "Password", font  = ("times new roman", 15), bg = "white") .place(x = 350, y = 230)
        ...
        txt_password = Entry(self.root, textvariable = self.var_password, font  = ("times new roman", 15), bg = "lightyellow") .place(x = 500, y = 230, width = 180)
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                if row != None:
                    ...
                    cur.execute("insert into employee(eid, name, email, gender, contact, dob, doj, password, utype, address, salary)" "values(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (
                        self.var_emp_id.get(),
                        self.var_name.get(),
                        self.var_email.get(),
                        self.var_gender.get(),
        ...
        try:
            if self.var_emp_id.get() == "":
                ...
                if row == None:
                    ...
                    cur.execute("update employee set name = %s, email = %s, gender = %s, contact = %s, dob = %s, doj = %s, password = %s, utype = %s, address = %s, salary = %s where eid = %s", (
                        self.var_name.get(),
                        self.var_email.get(),
                        self.var_gender.get(),
                        self.var_contact.get(),
